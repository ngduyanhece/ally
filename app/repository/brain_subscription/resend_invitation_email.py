...
from app.models.settings import BrainSettings
from app.repository.brain.get_brain_details import get_brain_details
from app.repository.brain_subscription.get_brain_url import get_brain_url
...
def resend_invitation_email(
    ...
    inviter_email: str,
    origin: str = "https://www.allyai.ai",
):
        ...
        r = resend.Emails.send(
            {
                ...
                "subject": "Ally - Brain Shared With You",
                "html": html_body,
            }
        )
