...
from app.auth.api_key_handler import get_user_from_api_key, verify_api_key
from app.auth.jwt_token_handler import decode_access_token, verify_token
...
def get_current_user(
        user: UserIdentity = Depends(AuthBearer())) -> UserIdentity:
    return user
