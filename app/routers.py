...
from app.routes import (api_key, brain, brain_subscription, chat, emoji,
                        explore, health, knowledge, label, learn, meta_brain,
                        misc, notification, onboarding, prompt, test, upload,
                        user)
...
router.include_router(learn.router, prefix="", tags=["Brain Learning"])
