...
image = (
	Image.from_registry("ghcr.io/huggingface/text-generation-inference:1.1.0")
	.dockerfile_commands("ENTRYPOINT []")
	.run_function(download_model, secret=Secret.from_name("my-huggingface-secret"))
	.pip_install("text-generation")
)

stub = Stub("ally-tgi-" + MODEL_ID.split("/")[-1], image=image)
...
class Model:
	...
	@method()
	async def generate(self, question: str, invocation_params: dict = {}):
		result = await self.client.generate(question, **invocation_params)
